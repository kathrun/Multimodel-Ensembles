...
'''
Top level script to create metrics for all NPC values to create graphs in following figures ...
...
```
'''
#Goal: Save all simple NPC metrics in a pickle for all NPC, all events, all mag groups, and all threshold 
...
for n in npc:
    ...
    npc_tab = BinaryEventTable(t_npc, tables['SWMF'].obsmax,t_npc, npc_forecast, 0.3,
