'''
Requires run analysis_scripts/gen_npc_mets.py and gen_meanmed_met.py
'''
...
fig.subplots_adjust(wspace=0.05, hspace=0.05, right=0.95)
row1, row2, row3, row4 = fig.subplots(4, 4, sharey='col')
