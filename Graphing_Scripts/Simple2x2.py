...
if not os.path.exists(metfile):
    raise FileNotFoundError('Cannot find pickled all mags data. See docstring for halp')
...
if not os.path.exists(metfile):
    raise FileNotFoundError('Cannot find pickled hi mags data. See docstring for halp')
...
if not os.path.exists(metfile):
    raise FileNotFoundError('Cannot find pickled lo mags data. See docstring for halp')
...
if not os.path.exists(metfile):
    raise FileNotFoundError('Cannot find pickled deterministic data. See docstring for halp')
...
ax2.plot(npc, pofd_hi, '-C0', label='High', marker='o', markersize='10', linewidth=5)
ax2.plot(npc, pofd_lo, '-C2', label="Low", marker='o', markersize='10', linewidth=5)
...
# plot mag groups
ax4.plot(npc, mme_all['bias03'], '-C1', label='All', marker='o', markersize='10', linewidth=5)
ax4.plot(npc, mme_hi['bias03'], '-C0', label='High', marker='o', markersize='10', linewidth=5)
ax4.plot(npc, mme_lo['bias03'], '-C2', label="Low", marker='o', markersize='10', linewidth=5)
